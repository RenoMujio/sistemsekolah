                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id_siswa" value="">
                        <div class="form-group">
                            ...
                            <input type="number" name="id_kelas" class="form-control" id="id_kelas" value="">
                            <small class="form-text text-danger"><?= form_error('id_kelas'); ?></small>
                        </div>
                        <div class="form-group">
                            <label for="nama_keahlian">keahlian</label>
                            <input type="text" name="nama_keahlian" class="form-control" id="nama_keahlian" value="">
                            <small class="form-text text-danger"><?= form_error('nama_keahlian'); ?></small>
                        </div>
                        <div class="form-group">
                            <label for="kaproli">kaproli</label>
                            <input type="text" name="kaproli" class="form-control" id="kaproli" value="">
